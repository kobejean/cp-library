...
data:
  ...
  code: "# verification-helper: PROBLEM https://atcoder.jp/contests/abc245/tasks/abc245_f\n\
    ...
    \                        cyc[v] = True\n            case 1:\n                cyc[u]\
    \ = any(cyc[v] for v in G[u])\n        state[u] += 1\n    return cyc\n\n\nfrom\
    \ cp_library.alg.graph.csr.digraph_cls import DiGraph\nfrom cp_library.io.read_fn\
...
layout: document
redirect_from:
- /verify/test/atcoder/abc/abc245_f_digraph.test.py
- /verify/test/atcoder/abc/abc245_f_digraph.test.py.html
