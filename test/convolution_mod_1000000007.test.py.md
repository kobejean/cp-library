...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/convolution_mod_1000000007\n\
    \ndef main():\n    N, M = read()\n    A = read(list[int])\n    B = read(list[int])\n\
  ...
  code: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/convolution_mod_1000000007\n\
    \ndef main():\n    N, M = read()\n    A = read(list[int])\n    B = read(list[int])\n\
    \    C = [c%1000000007 for c in conv_int(A, B)]\n    write(*C)\n\nfrom cp_library.math.nt.conv_int_fn\
  ...
  verifiedWith: []
documentation_of: test/convolution_mod_1000000007.test.py
layout: document
redirect_from:
- /verify/test/convolution_mod_1000000007.test.py
- /verify/test/convolution_mod_1000000007.test.py.html
