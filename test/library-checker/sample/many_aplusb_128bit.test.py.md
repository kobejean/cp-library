...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/many_aplusb_128bit\n\
    \ndef solve():\n    A, B = read()\n    return A+B\n\ndef main():\n    T = read(int)\n\
    \    for _ in range(T):\n        ans = solve()\n        write(ans)\n\n'''\n\u257A\
    \u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    \u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
  ...
  verifiedWith: []
documentation_of: test/library-checker/sample/many_aplusb_128bit.test.py
layout: document
redirect_from:
- /verify/test/library-checker/sample/many_aplusb_128bit.test.py
- /verify/test/library-checker/sample/many_aplusb_128bit.test.py.html
