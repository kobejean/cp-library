...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/convolution_mod\n\
    ...
    \ int(*args, **kwargs)) < 64: return cls.cache[x]\n        else: return cls.fix(x)\n\
...
layout: document
redirect_from:
- /verify/test/library-checker/convolution/convolution.test.py
- /verify/test/library-checker/convolution/convolution.test.py.html
