...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/stirling_number_of_the_first_kind\n\
    ...
    \ a in enumerate(reversed(R))]\n\n\ndef stirling1_n(n: SupportsIndex, signed =\
...
layout: document
redirect_from:
- /verify/test/library-checker/enumerative-combinatorics/stirling_number_of_the_first_kind.test.py
- /verify/test/library-checker/enumerative-combinatorics/stirling_number_of_the_first_kind.test.py.html
