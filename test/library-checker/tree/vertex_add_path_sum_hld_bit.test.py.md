...
data:
  ...
  code: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/vertex_add_path_sum\n\
    ...
    \    T = read(Tree[N,0])\n    hld = HLDBIT(T, A)\n\n    for _ in range(Q):\n \
    \       t, u, v = read()\n        if t == 0:\n            hld.add(u, v)\n    \
    \    else:\n            write(hld.path_query(u, v))\n\nfrom cp_library.alg.tree.fast.hld_bit_cls\
  ...
  verifiedWith: []
documentation_of: test/library-checker/tree/vertex_add_path_sum_hld_bit.test.py
layout: document
redirect_from:
- /verify/test/library-checker/tree/vertex_add_path_sum_hld_bit.test.py
- /verify/test/library-checker/tree/vertex_add_path_sum_hld_bit.test.py.html
