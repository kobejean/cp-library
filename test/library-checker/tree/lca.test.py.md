...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/lca\n\
    \ndef main():\n    N, Q = read()\n    U = range(1,N)\n    P = read(list[int])\n\
    \    T = Tree(N, P, U)\n    lca = LCATable(T)\n    for _ in range(Q):\n      \
    \  u, v = read()\n        a, _ = lca.query(u, v)\n        write(a)\n\n'''\n\u257A\
    \u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
...
layout: document
redirect_from:
- /verify/test/library-checker/tree/lca.test.py
- /verify/test/library-checker/tree/lca.test.py.html
