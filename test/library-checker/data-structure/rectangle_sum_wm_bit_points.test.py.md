...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/rectangle_sum\n\
    ...
    \    wm = WMBITPoints(X, Y, W)\n    for i in range(Q):\n        append(str(wm.sum_rect(*map(int,\
  ...
  verifiedWith: []
documentation_of: test/library-checker/data-structure/rectangle_sum_wm_bit_points.test.py
layout: document
redirect_from:
- /verify/test/library-checker/data-structure/rectangle_sum_wm_bit_points.test.py
- /verify/test/library-checker/data-structure/rectangle_sum_wm_bit_points.test.py.html
