...
data:
  ...
  code: "# verification-helper: PROBLEM https://judge.yosupo.jp/problem/static_range_sum\n\
    \ndef main():\n    N, Q = read()\n    A = read()\n    S = presum(A, initial=0)\n\
    \    for _ in range(Q):\n        l, r = read()\n        write(S[r]-S[l])\n\nfrom\
    \ cp_library.alg.iter.presum_fn import presum\nfrom cp_library.io.read_fn import\
...
layout: document
redirect_from:
- /verify/test/library-checker/data-structure/static_range_sum.test.py
- /verify/test/library-checker/data-structure/static_range_sum.test.py.html
