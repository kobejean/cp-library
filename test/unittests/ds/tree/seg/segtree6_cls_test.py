...
class TestSegTree6:
    def test_initialization_with_list(self):
        ...
        values = [(1, 10, 100, 1000, 10000, 100000), (2, 20, 200, 2000, 20000, 200000), 
                  (3, 30, 300, 3000, 30000, 300000), (4, 40, 400, 4000, 40000, 400000)]
        seg = SegTree6(lambda a, b: (a[0] + b[0], a[1] + b[1], a[2] + b[2], a[3] + b[3], a[4] + b[4], a[5] + b[5]), 
                       (0, 0, 0, 0, 0, 0), values)
        
        assert seg.n == 4
        assert seg[0] == (1, 10, 100, 1000, 10000, 100000)
    ...
    def test_set_and_get(self):
        ...
        seg[3] = (4, 40, 400, 4000, 40000, 400000)
    ...
    def test_prod_sum(self):
        ...
        # Test various ranges
        assert seg.prod(0, 4) == (10, 100, 1000, 10000, 100000, 1000000)  # Sum of all
        assert seg.prod(0, 2) == (3, 30, 300, 3000, 30000, 300000)        # First two
        assert seg.prod(1, 3) == (5, 50, 500, 5000, 50000, 500000)        # Middle two
        assert seg.prod(2, 4) == (7, 70, 700, 7000, 70000, 700000)        # Last two
        assert seg.prod(1, 2) == (2, 20, 200, 2000, 20000, 200000)        # Single element
        assert seg.prod(2, 2) == (0, 0, 0, 0, 0, 0)                       # Empty range

    def test_prod_max(self):
        """Test prod operation with max"""
        values = [(3, 30, 300, 3000, 30000, 300000), (1, 10, 100, 1000, 10000, 100000), 
                  (4, 40, 400, 4000, 40000, 400000), (2, 20, 200, 2000, 20000, 200000)]
        seg = SegTree6(
        ...
        assert seg.prod(0, 4) == (4, 40, 400, 4000, 40000, 400000)
        assert seg.prod(0, 2) == (3, 30, 300, 3000, 30000, 300000)
        assert seg.prod(1, 3) == (4, 40, 400, 4000, 40000, 400000)
        assert seg.prod(2, 4) == (4, 40, 400, 4000, 40000, 400000)
    ...
    def test_prod_min(self):
        ...
        assert seg.prod(0, 4) == (1, 10, 100, 1000, 10000, 100000)
        assert seg.prod(0, 2) == (1, 10, 100, 1000, 10000, 100000)
    ...
    def test_all_prod(self):
        ...
        assert seg.all_prod() == (10, 100, 1000, 10000, 100000, 1000000)
    ...
    def test_max_right(self):
        ...
        assert seg.max_right(0, lambda x: x[5] <= 300000) == 2 # Sum up to index 2 is 300000
    ...
    def test_min_left(self):
        ...
        assert seg.min_left(4, lambda x: x[5] <= 400000) == 3  # Only last element
    ...
    def test_update_and_query(self):
        ...
        assert seg.prod(0, 4) == (10, 100, 1000, 10000, 100000, 1000000)
        
        # Update some values
        seg[1] = (5, 50, 500, 5000, 50000, 500000)
    ...
    def test_empty_tree(self):
        ...
        assert seg.n == 0
        assert seg.all_prod() == (0, 0, 0, 0, 0, 0)
    ...
    def test_single_element(self):
        ...
        assert seg.n == 1
        assert seg[0] == (5, 50, 500, 5000, 50000, 500000)
    ...
    def test_large_tree(self):
        ...
        n = 1000
        values = [(i, i * 10, i * 100, i * 1000, i * 10000, i * 100000) for i in range(n)]
        seg = SegTree6(lambda a, b: (a[0] + b[0], a[1] + b[1], a[2] + b[2], a[3] + b[3], a[4] + b[4], a[5] + b[5]), 
                       (0, 0, 0, 0, 0, 0), values)
        
        # Sum of 0..999 = 499500
        assert seg.all_prod() == (499500, 4995000, 49950000, 499500000, 4995000000, 49950000000)
        
        # Sum of 0..99 = 4950
        assert seg.prod(0, 100) == (4950, 49500, 495000, 4950000, 49500000, 495000000)
        
        # Update and verify
        seg[500] = (1000, 10000, 100000, 1000000, 10000000, 100000000)
        ...
        assert seg.all_prod() == (expected_sum, 4995000 - 5000 + 10000, 49950000 - 50000 + 100000, 
                                  ...
                                  49950000000 - 50000000 + 100000000)

    def test_different_types(self):
        """Test with different data types in tuples"""
        # String concatenation, list concatenation, set union, counting, boolean operations, and dictionary merging
        def dict_merge(a, b):
            result = a.copy()
            result.update(b)
            return result
        ...
        seg = SegTree6(
            lambda a, b: (a[0] + b[0], a[1] + b[1], a[2] | b[2], a[3] + b[3], a[4] and b[4], dict_merge(a[5], b[5])),
            ("", [], set(), 0, True, {}),
            [("a", [1], {1}, 1, True, {'x': 1}), ("b", [2], {2}, 1, False, {'y': 2}), 
             ("c", [3], {3}, 1, True, {'z': 3}), ("d", [4], {4}, 1, True, {'w': 4})]
        )
        
        assert seg.prod(0, 2) == ("ab", [1, 2], {1, 2}, 2, False, {'x': 1, 'y': 2})
        assert seg.prod(1, 4) == ("bcd", [2, 3, 4], {2, 3, 4}, 3, False, {'y': 2, 'z': 3, 'w': 4})
        assert seg.all_prod() == ("abcd", [1, 2, 3, 4], {1, 2, 3, 4}, 4, False, {'x': 1, 'y': 2, 'z': 3, 'w': 4})
    ...
    def test_complex_operation(self):
        ...
        values = [(3, 3, 3, 1, 9, 27), (1, 1, 1, 1, 1, 1), (4, 4, 4, 1, 16, 64), (2, 2, 2, 1, 4, 8)]
        seg = SegTree6(combine, (float('inf'), float('-inf'), 0, 0, 0, 0), values)
        
        assert seg.prod(0, 4) == (1, 4, 10, 4, 30, 100)  # min=1, max=4, sum=10, count=4, sum_sq=30, sum_cube=100
        assert seg.prod(0, 2) == (1, 3, 4, 2, 10, 28)    # min=1, max=3, sum=4, count=2, sum_sq=10, sum_cube=28
        assert seg.prod(2, 4) == (2, 4, 6, 2, 20, 72)    # min=2, max=4, sum=6, count=2, sum_sq=20, sum_cube=72
    ...
    def test_stress_random_operations(self):
        ...
        values = [(random.randint(1, 100), random.randint(1, 100), random.randint(1, 100), 
                  random.randint(1, 100), random.randint(1, 100), random.randint(1, 100)) for _ in range(n)]
        seg = SegTree6(lambda a, b: (a[0] + b[0], a[1] + b[1], a[2] + b[2], a[3] + b[3], a[4] + b[4], a[5] + b[5]), 
                       (0, 0, 0, 0, 0, 0), values)
