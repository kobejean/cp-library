...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://atcoder.jp/contests/abc218/tasks/abc218_f\n\
    ...
    \ Va = fill_u32(N), fill_u32(M), fill_u32(M), fill_u32(M)\n        for u in U:\
  ...
  verifiedWith: []
documentation_of: test/abc218_f_fast_shortest_path.test.py
layout: document
redirect_from:
- /verify/test/abc218_f_fast_shortest_path.test.py
- /verify/test/abc218_f_fast_shortest_path.test.py.html
