...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/1/GRL/all/GRL_1_B\n\
    ...
    \ edges in enumerate(G) for v,w in edges)\n\n    if neg_cycle:\n        print(\"\
    NEGATIVE CYCLE\")\n    else:\n        print(*('INF' if d == inft else d for d\
  ...
  code: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/1/GRL/all/GRL_1_B\n\
    ...
    \ = any(D[u]+w<D[v] for u, edges in enumerate(G) for v,w in edges)\n\n    if neg_cycle:\n\
...
layout: document
redirect_from:
- /verify/test/grl_1_b_graph_bellman_ford.test.py
- /verify/test/grl_1_b_graph_bellman_ford.test.py.html
