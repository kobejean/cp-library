...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/all/GRL_5_A\n\
    ...
    \ elist(2*N), elist(2*N), elist(2*N)\n        \n        stack, Wstack = elist(N),\
    \ elist(N)\n        stack.append(s)\n        Wstack.append(0)\n        while stack:\n\
...
layout: document
redirect_from:
- /verify/test/aoj/grl/grl_5_a_fast_diameter.test.py
- /verify/test/aoj/grl/grl_5_a_fast_diameter.test.py.html
