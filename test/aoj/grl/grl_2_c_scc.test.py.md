...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/3/GRL_3_C\n\
    ...
    \ = u32f(N := G.N), u8f(N), elist(N), [0]*N, 0\n    \n    def enter(u):\n    \
...
layout: document
redirect_from:
- /verify/test/aoj/grl/grl_2_c_scc.test.py
- /verify/test/aoj/grl/grl_2_c_scc.test.py.html
