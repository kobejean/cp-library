...
data:
  ...
  bundledCode: "# verification-helper: PROBLEM https://onlinejudge.u-aizu.ac.jp/courses/library/1/GRL/all/GRL_1_A\n\
    ...
    \ Wa = u32f(N), u32f(M := len(U)), u32f(M), u32f(M), [0]*M\n        for u in U:\
    \ deg[u] += 1\n        La, i = u32f(N), 0\n        for u in range(N): La[u], i\
...
layout: document
redirect_from:
- /verify/test/aoj/grl/grl_1_a_graph_distance.test.py
- /verify/test/aoj/grl/grl_1_a_graph_distance.test.py.html
