...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/atcoder/abc/abc184_e_grid_graph_bfs_fn.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/atcoder/abc/abc184_e_grid_graph_bfs_fn.test.py
env = dict(os.environ)
