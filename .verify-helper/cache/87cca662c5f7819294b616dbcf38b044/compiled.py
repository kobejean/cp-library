...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/atcoder/abc/abc294_g_fast_tree_hld_bit.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/atcoder/abc/abc294_g_fast_tree_hld_bit.test.py
env = dict(os.environ)
