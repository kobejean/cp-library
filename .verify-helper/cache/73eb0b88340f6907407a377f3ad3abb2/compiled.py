...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/min_plus_convolution_convex_arbitrary.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/min_plus_convolution_convex_arbitrary.test.py
env = dict(os.environ)
