...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/atcoder/arc/arc136_b_inversion_cnt_fn.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/atcoder/arc/arc136_b_inversion_cnt_fn.test.py
env = dict(os.environ)
