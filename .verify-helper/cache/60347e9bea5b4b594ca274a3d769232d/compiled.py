...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/output/test/dp_v_subtree_rerooting_recursive.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run output/test/dp_v_subtree_rerooting_recursive.test.py
env = dict(os.environ)
