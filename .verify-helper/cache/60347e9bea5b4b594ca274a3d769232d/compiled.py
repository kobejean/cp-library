...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/atcoder/dp/dp_v_subtree_rerooting_recursive.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/atcoder/dp/dp_v_subtree_rerooting_recursive.test.py
env = dict(os.environ)
