...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/atcoder/arc/arc122_b_insurance_median.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/atcoder/arc/arc122_b_insurance_median.test.py
env = dict(os.environ)
