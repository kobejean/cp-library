...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/atcoder/arc/arc168_c_swap_characters_combinatoric.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/atcoder/arc/arc168_c_swap_characters_combinatoric.test.py
env = dict(os.environ)
