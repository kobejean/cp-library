...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/abc337_g_tree_inversion_heavy_light_decomposition.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/abc337_g_tree_inversion_heavy_light_decomposition.test.py
env = dict(os.environ)
