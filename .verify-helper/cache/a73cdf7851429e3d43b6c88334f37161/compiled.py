...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/atcoder/abc/abc218_f_shortest_path_weighted.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/atcoder/abc/abc218_f_shortest_path_weighted.test.py
env = dict(os.environ)
