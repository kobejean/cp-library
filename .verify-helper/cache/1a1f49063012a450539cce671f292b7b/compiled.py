...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/output/_test/abc362_q_count_substring_query_ahocorasick.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run output/_test/abc362_q_count_substring_query_ahocorasick.test.py
env = dict(os.environ)
