...
# arguments
path = '/Users/kobejean/Developer/GitHub/cp-library/test/atcoder/dp/dp_z_cht_monotone_add_min.test.py'
basedir = '/Users/kobejean/Developer/GitHub/cp-library'

# run test/atcoder/dp/dp_z_cht_monotone_add_min.test.py
env = dict(os.environ)
