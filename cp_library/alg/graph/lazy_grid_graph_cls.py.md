...
data:
  ...
  code: "import cp_library.alg.graph.__header__\n\nfrom collections.abc import Iterator\n\
    ...
    \ GridGraphProtocol\n\nclass LazyGridGraph(GridGraphProtocol):\n\n    def neighbors(G,\
    \ u: int) -> Iterable[int]:\n        S, wall, dirs, H, W = G.S, G.wall, G.dirs,\
    \ G.H, G.W\n        i,j = divmod(u, W)\n        return tuple(v\n            for\
    \ di,dj in dirs\n                if (0 <= (ni:=i+di) < H \n                  \
...
documentation_of: cp_library/alg/graph/lazy_grid_graph_cls.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/lazy_grid_graph_cls.py
- /library/cp_library/alg/graph/lazy_grid_graph_cls.py.html
