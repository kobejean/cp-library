...
data:
  ...
  code: "from math import inf\nimport cp_library.alg.graph.__header__\n\nfrom typing\
    ...
    \ import DFSEvent, DFSFlags\nfrom cp_library.alg.graph.fast.graph_proto import\
    \ GraphProtocol\n\nclass GraphWeightedProtocol(GraphProtocol):\n    \n    @overload\n\
    \    def distance(G) -> list[list[int]]: ...\n    @overload\n    def distance(G,\
    ...
    \ import fill_i32, fill_u32, fill_u64\nfrom cp_library.ds.priority_queue_cls import\
...
documentation_of: cp_library/alg/graph/fast/graph_weighted_proto.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/fast/graph_weighted_proto.py
- /library/cp_library/alg/graph/fast/graph_weighted_proto.py.html
