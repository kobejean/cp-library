...
data:
  ...
  verifiedWith: []
documentation_of: cp_library/alg/graph/fast/edge_list_cls.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/fast/edge_list_cls.py
- /library/cp_library/alg/graph/fast/edge_list_cls.py.html
