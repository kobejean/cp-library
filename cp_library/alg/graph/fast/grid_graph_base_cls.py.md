...
data:
  ...
  bundledCode: "import sys\n'''\n\u257A\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    ...
    \nclass Parsable:\n    @classmethod\n    def compile(cls):\n        def parser(ts:\
    \ TokenStream):\n            return cls(next(ts))\n        return parser\nfrom\
    \ typing import Sequence, Union, overload\n\nfrom enum import auto, IntFlag, IntEnum\n\
    ...
    \                 return False\n        return True\n    \n    def starts(G, s:\
    \ Union[int,list[int],None]) -> list[int]:\n        match s:\n            case\
...
documentation_of: cp_library/alg/graph/fast/grid_graph_base_cls.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/fast/grid_graph_base_cls.py
- /library/cp_library/alg/graph/fast/grid_graph_base_cls.py.html
