...
data:
  ...
  verifiedWith: []
documentation_of: cp_library/alg/graph/fast/snippets/is_bipartite_fn.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/fast/snippets/is_bipartite_fn.py
- /library/cp_library/alg/graph/fast/snippets/is_bipartite_fn.py.html
