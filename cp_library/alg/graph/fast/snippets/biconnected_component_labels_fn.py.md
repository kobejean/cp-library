...
data:
  ...
  bundledCode: "'''\n\u257A\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    ...
    \ key) -> tuple[int,int]:\n        x = lst.A[key]\n        return x >> lst.shift,\
    \ x & lst.mask\n\n\ndef biconnected_component_labels(G: GraphBase, s: Union[int,list,None]\
    \ = None) -> Iterable[list[int]]:\n    '''\n    Returns a list of edge biconnected\
  ...
  verifiedWith: []
documentation_of: cp_library/alg/graph/fast/snippets/biconnected_component_labels_fn.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/fast/snippets/biconnected_component_labels_fn.py
- /library/cp_library/alg/graph/fast/snippets/biconnected_component_labels_fn.py.html
