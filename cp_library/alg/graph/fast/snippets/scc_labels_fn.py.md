...
documentation_of: cp_library/alg/graph/fast/snippets/scc_labels_fn.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/fast/snippets/scc_labels_fn.py
- /library/cp_library/alg/graph/fast/snippets/scc_labels_fn.py.html
