...
documentation_of: cp_library/alg/graph/fast/graph_proto.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/fast/graph_proto.py
- /library/cp_library/alg/graph/fast/graph_proto.py.html
