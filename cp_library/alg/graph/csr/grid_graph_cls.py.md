...
data:
  ...
  code: "import cp_library.__header__\nimport cp_library.alg.__header__\nimport cp_library.alg.graph.__header__\n\
    import cp_library.alg.graph.csr.__header__\nfrom cp_library.alg.graph.csr.grid_graph_walled_base_cls\
    ...
    \        for i,u in enumerate(G.Ua):\n            for j in G.range(G.Va[i]):\n\
    \                if G.Va[j] == u:\n                    G.twin[i] = j\n       \
    \ G.M, G.Ea = len(Ua), u32a(range(G.M))\nfrom cp_library.ds.array.u32a_fn import\
...
documentation_of: cp_library/alg/graph/csr/grid_graph_cls.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/csr/grid_graph_cls.py
- /library/cp_library/alg/graph/csr/grid_graph_cls.py.html
