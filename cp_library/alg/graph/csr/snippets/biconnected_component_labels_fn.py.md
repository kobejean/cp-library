...
data:
  ...
  bundledCode: "'''\n\u257A\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    ...
    \ return hash(tuple(que.q[que.h:]))\n\n\ndef biconnected_component_labels(G: GraphBase,\
    \ s: Union[int,list,None] = None) -> Iterable[list[int]]:\n    '''\n    Returns\
    \ a list of edge biconnected component classifications.\n    '''\n    low, st,\
    \ bccs, id = [N := G.N]*N, elist(G.M), [-1]*len(G.Ea), -1\n\n    def back(u,v,i):\n\
    \        st.append(i)\n        chmin(low, u, G.tin[v])\n\n    def down(u,v,i):\n\
    \        st.append(i)\n        low[v] = G.tin[v]\n\n    def up(u,p,i):\n     \
    \   nonlocal id\n        chmin(low, p, low[u])\n        if low[u] >= G.tin[p]:\n\
    \            # add new biconnected component\n            j = -1; id += 1\n  \
    \          while j != i:\n                bccs[j := st.pop()] = bccs[G.twin[j]]\
  ...
  code: "import cp_library.__header__\nfrom typing import Iterable, Union\nimport\
    ...
    \ndef biconnected_component_labels(G: GraphBase, s: Union[int,list,None] = None)\
    \ -> Iterable[list[int]]:\n    '''\n    Returns a list of edge biconnected component\
    \ classifications.\n    '''\n    low, st, bccs, id = [N := G.N]*N, elist(G.M),\
    \ [-1]*len(G.Ea), -1\n\n    def back(u,v,i):\n        st.append(i)\n        chmin(low,\
    \ u, G.tin[v])\n\n    def down(u,v,i):\n        st.append(i)\n        low[v] =\
    \ G.tin[v]\n\n    def up(u,p,i):\n        nonlocal id\n        chmin(low, p, low[u])\n\
    \        if low[u] >= G.tin[p]:\n            # add new biconnected component\n\
...
layout: document
redirect_from:
- /library/cp_library/alg/graph/csr/snippets/biconnected_component_labels_fn.py
- /library/cp_library/alg/graph/csr/snippets/biconnected_component_labels_fn.py.html
