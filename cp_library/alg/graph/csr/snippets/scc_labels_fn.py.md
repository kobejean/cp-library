...
data:
  ...
  code: "import cp_library.__header__\nfrom typing import Iterator\nimport cp_library.alg.__header__\n\
    ...
    \ndef scc_labels(G: 'DiGraph') -> Iterator[list[int]]:\n    low, on, st, sccs,\
    \ id = u32f(N := G.N), u8f(N), elist(N), [0]*N, 0\n    \n    def enter(u):\n \
    \       low[u] = G.tin[u]\n        st.append(u)\n        on[u] = 1\n\n    def\
    \ back_or_cross(u,v,i):\n        if on[v]: chmin(low, u, G.tin[v])\n\n    def\
    \ leave(u):\n        nonlocal id\n        if low[u] == G.tin[u]:\n           \
    \ v, id = -1, id+1\n            while v != u:\n                on[v := st.pop()]\
...
documentation_of: cp_library/alg/graph/csr/snippets/scc_labels_fn.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/csr/snippets/scc_labels_fn.py
- /library/cp_library/alg/graph/csr/snippets/scc_labels_fn.py.html
