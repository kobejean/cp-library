...
data:
  ...
  code: "import cp_library.__header__\nfrom typing import Iterator\nimport cp_library.alg.__header__\n\
    ...
    \n    def up(u,v,i):\n        chmin(low, v, low[u])\n\n    G.dfs(enter_fn=enter,\
    \ back_fn=back_or_cross, cross_fn=back_or_cross, leave_fn=leave, up_fn=up)\n \
    \   return SliceIteratorReverse(sccs, L)\nfrom cp_library.alg.graph.csr.digraph_cls\
...
documentation_of: cp_library/alg/graph/csr/snippets/strongly_connected_components_fn.py
layout: document
redirect_from:
- /library/cp_library/alg/graph/csr/snippets/strongly_connected_components_fn.py
- /library/cp_library/alg/graph/csr/snippets/strongly_connected_components_fn.py.html
