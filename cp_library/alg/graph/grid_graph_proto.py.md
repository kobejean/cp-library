...
data:
  ...
  code: "import sys\nimport cp_library.alg.graph.__header__\n\nfrom cp_library.io.parser_cls\
    ...
    \nclass GridGraphProtocol(GraphProtocol):\n\n    def __init__(G, H, W, S=str,\
    \ dirs = [(-1,0),(0,1),(1,0),(0,-1)], wall = '#', adj = None):\n        super().__init__(W*H,\
    \ None, adj)\n        G.W = W\n        G.H = H\n        G.S = S\n        G.dirs\
    \ = dirs\n        G.wall = wall\n\n    def vertex(G, key: tuple[int,int] | int):\n\
    \        match key:\n            case i, j: return i*G.W+j\n            case v:\
    \ return v\n\n    def is_valid(G, i, j, v):\n        return 0 <= i < G.H and 0\
    \ <= j < G.W and G.S[v] != G.wall\n    \n    @classmethod\n    def compile(cls,\
    \ H: int, W: int, *args):\n        def parse(ts: TokenStream):\n            S\
...
layout: document
redirect_from:
- /library/cp_library/alg/graph/grid_graph_proto.py
- /library/cp_library/alg/graph/grid_graph_proto.py.html
