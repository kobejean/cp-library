...
data:
  ...
  code: "import cp_library.__header__\nfrom typing import Callable, Generic\nfrom\
    ...
    \         vs = hld.op(hld.pre.prod(hld.tin[u]+edge, hld.tin[v]+1), vs)\n     \
    \   else:\n            us = hld.op(us, hld.suf.prod(hld.N-1-hld.tin[u], hld.N-hld.tin[v]-edge))\n\
    \        return hld.op(us, vs)\n\nfrom cp_library.ds.tree.seg.segtree_cls import\
    \ SegTree"
  dependsOn:
...
documentation_of: cp_library/alg/tree/csr/hld_monoid_cls.py
layout: document
redirect_from:
- /library/cp_library/alg/tree/csr/hld_monoid_cls.py
- /library/cp_library/alg/tree/csr/hld_monoid_cls.py.html
