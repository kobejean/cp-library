...
data:
  ...
  bundledCode: "'''\n\u257A\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    ...
    \    pass\n\n"
  code: "import cp_library.alg.tree.csr.__header__\nfrom cp_library.alg.graph.csr.graph_weighted_cls\
    \ import GraphWeighted\nfrom cp_library.alg.tree.csr.tree_weighted_base_cls import\
    \ TreeWeightedBase\n\nclass TreeWeighted(TreeWeightedBase, GraphWeighted):\n \
    \   pass\n\n"
  dependsOn:
...
documentation_of: cp_library/alg/tree/csr/tree_weighted_cls.py
layout: document
redirect_from:
- /library/cp_library/alg/tree/csr/tree_weighted_cls.py
- /library/cp_library/alg/tree/csr/tree_weighted_cls.py.html
