...
data:
  ...
  code: "import cp_library.__header__\nimport cp_library.alg.__header__\nimport cp_library.alg.iter.__header__\n\
    ...
    \ distinct = False):\n    s, m = pack_sm((N := len(A))-1); R, V = [0]*N, [a<<s|i\
    \ for i,a in enumerate(A)]; V.sort()\n    if distinct:\n        for r, ai in enumerate(V):\
...
documentation_of: cp_library/alg/iter/cmpr/coord_compress_fn.py
layout: document
redirect_from:
- /library/cp_library/alg/iter/cmpr/coord_compress_fn.py
- /library/cp_library/alg/iter/cmpr/coord_compress_fn.py.html
