...
class mint(int):
    ...
    def __floordiv__(self, other): return mint(super().__mul__(pow(int(other),-1,self.mod)))
    def __rfloordiv__(self, other): return mint(int.__mul__(other,pow(int(self),-1,self.mod)))
