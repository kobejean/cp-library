...
data:
  ...
  bundledCode: "'''\n\u257A\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    ...
    \ [int(inv[t]*pow(t,n,mod)) for t in range(n+1)]\n    B = [int(inv[t]*(sign:=mod-sign))\
  ...
  code: "import cp_library.math.table.__header__\nfrom typing import SupportsIndex\n\
    ...
    \ import modcomb\n\ndef stirling2_n(n: SupportsIndex):\n    inv,conv,sign = modcomb.fact_inv,mint.ntt.conv,(mod:=mint.mod)-1\n\
    \    A = [int(inv[t]*pow(t,n,mod)) for t in range(n+1)]\n    B = [int(inv[t]*(sign:=mod-sign))\
    \ for t in range(n+1)]\n    return [mint(x) for x in conv(A, B, n+1)]"
  dependsOn:
...
documentation_of: cp_library/math/table/stirling2_n_fn.py
layout: document
redirect_from:
- /library/cp_library/math/table/stirling2_n_fn.py
- /library/cp_library/math/table/stirling2_n_fn.py.html
