...
data:
  ...
  bundledCode: "'''\n\u257A\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    ...
    \ -> list[int]:\n    fwht(A, N)\n    inv = pow(1 << N, -1, mod)\n    for i, a\
    \ in enumerate(A): A[i] = a%mod * inv%mod\n    return A\n"
...
documentation_of: cp_library/math/conv/mod/fwht_inv_fn.py
layout: document
redirect_from:
- /library/cp_library/math/conv/mod/fwht_inv_fn.py
- /library/cp_library/math/conv/mod/fwht_inv_fn.py.html
