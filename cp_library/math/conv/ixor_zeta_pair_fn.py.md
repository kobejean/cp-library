...
data:
  ...
  bundledCode: "'''\n\u257A\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    ...
    \u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\
    \u2501\u2501\u2501\u2501\u2501\u2501\u2578\n                      Math - Convolution\
    \                     \n'''\n\ndef ixor_zeta_pair(A: list[int], B: list[int],\
    \ N: int):\n    Z = len(A)\n    for i in range(N):\n        m = b = 1<<i\n   \
...
documentation_of: cp_library/math/conv/ixor_zeta_pair_fn.py
layout: document
redirect_from:
- /library/cp_library/math/conv/ixor_zeta_pair_fn.py
- /library/cp_library/math/conv/ixor_zeta_pair_fn.py.html
