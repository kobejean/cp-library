...
data:
  ...
  code: "import cp_library.__header__\nfrom cp_library.bit.popcnts_fn import popcnts\n\
    ...
    \ cp_library.math.conv.isubset_deconv_ranked_fn import isubset_deconv_ranked\n\
    \ndef subset_deconv(A: list[int], B: list[int], N: int) -> list[int]:\n    Z =\
    \ (N+1)*(M:=1<<N)\n    Ar, Br, C, P = [0]*Z, [0]*Z, [0]*M, popcnts(N)\n    for\
...
documentation_of: cp_library/math/conv/subset_deconv_fn.py
layout: document
redirect_from:
- /library/cp_library/math/conv/subset_deconv_fn.py
- /library/cp_library/math/conv/subset_deconv_fn.py.html
