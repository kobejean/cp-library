...
data:
  ...
  code: "import cp_library.__header__\nimport cp_library.math.__header__\nimport cp_library.math.conv.__header__\n\
    \ndef iand_zeta_pair(A: list[int], B: list[int], N: int):\n    Z = len(A)\n  \
    \  for i in range(N):\n        m = b = 1<<i\n        while m < Z: A[m^b] += A[m];\
    \ B[m^b] += B[m]; m = m+1|b\n    return A\n"
  dependsOn: []
...
documentation_of: cp_library/math/conv/iand_zeta_pair_fn.py
layout: document
redirect_from:
- /library/cp_library/math/conv/iand_zeta_pair_fn.py
- /library/cp_library/math/conv/iand_zeta_pair_fn.py.html
