...
data:
  ...
  code: "import cp_library.__header__\nfrom cp_library.misc.typing import _T\nimport\
    ...
    \ b): return a[0] + b[0], a[1] + b[1], a[2] + b[2], a[3] + b[3], a[4] + b[4]\n\
    \    def _sub(bit, a, b): return a[0] - b[0], a[1] - b[1], a[2] - b[2], a[3] -\
    \ b[3], a[4] - b[4]"
  dependsOn:
...
documentation_of: cp_library/ds/tree/bit/bit5_cls.py
layout: document
redirect_from:
- /library/cp_library/ds/tree/bit/bit5_cls.py
- /library/cp_library/ds/tree/bit/bit5_cls.py.html
